...
public class HistogramEncoding {

   private static final long highestTrackableValue = TimeUnit.SECONDS.toNanos(10);

   private ByteBuffer encodedHistogram;
   private Histogram original;
